...
*/
    ...
    // {{
                            ...
                            $attributes_has_price = !empty(\common\models\ProductsAttributes::find()->where(['products_id' => (int) $products_id ])->andWhere(['>', 'options_values_price', 0])->one());
