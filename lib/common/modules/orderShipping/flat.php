...
// class methods
    ...
    public function configure_keys() {
        return array(
            ...
            'MODULE_SHIPPING_FLAT_DATE_SETTING' => array (
            ...
            'MODULE_SHIPPING_FLAT_DISABLED_DAYS' => array (
    ...
    {
        $response = false;
        if (defined('MODULE_SHIPPING_FLAT_DATE_SETTING') && MODULE_SHIPPING_FLAT_DATE_SETTING == 'Use ownership') {
            if (defined('MODULE_SHIPPING_FLAT_DISABLED_DAYS')) {
                $response = explode(",", MODULE_SHIPPING_FLAT_DISABLED_DAYS);
