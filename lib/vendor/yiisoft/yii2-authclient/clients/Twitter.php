...
class Twitter extends OAuth1
{
    ...
    public static function getAddonSettings(){
        return [
        'posts' => [
                'TW_ACCESS_TOKEN' => ['value' => '', 'description' => 'Access token'],
                'TW_ACCESS_TOKEN_SECRET' => ['value' => '', 'description' => 'Access token secret'],
                'TW_CONSUMER_KEY' => ['value' => '', 'description' => 'Consumer key'],
                'TW_CONSUMER_SECRET' => ['value' => '', 'description' => 'Consumer secret'],
                'TW_SCREEN_NAME' => ['value' => '', 'description' => 'Screen name'],
            ]
        ];
    }
