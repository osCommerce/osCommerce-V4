...
import 'svgedit/editor/touch.js';
import {NS} from 'svgedit/editor/namespaces.js';
import {isWebkit, isChrome, isGecko, isIE, isMac, isTouch} from 'svgedit/editor/browser.js';
import * as Utils from 'svgedit/editor/utilities.js';
import {getTypeMap, convertUnit, isValidUnit} from 'svgedit/editor/units.js';
import {
  hasCustomHandler, getCustomHandler, injectExtendedContextMenuItemsIntoDom
} from 'svgedit/editor/contextmenu.js';
import {importSetGlobalDefault} from 'svgedit/editor/external/dynamic-import-polyfill/importModule.js';

import SvgCanvas from 'svgedit/editor/svgcanvas.js';
import Layer from 'svgedit/editor/layer.js';

import jQueryPluginJSHotkeys from 'svgedit/editor/js-hotkeys/jquery.hotkeys.min.js';
import jQueryPluginBBQ from 'svgedit/editor/jquerybbq/jquery.bbq.min.js';
import jQueryPluginSVGIcons from 'svgedit/editor/svgicons/jQuery.svgIcons.js';
import jQueryPluginJGraduate from 'svgedit/editor/jgraduate/jQuery.jGraduate.js';
import jQueryPluginSpinButton from 'svgedit/editor/spinbtn/jQuery.SpinButton.js';
import jQueryPluginSVG from 'svgedit/editor/jQuery.attr.js'; // Needed for SVG attribute setting and array form with `attr`
import jQueryPluginContextMenu from 'svgedit/editor/contextmenu/jQuery.contextMenu.js';
import jQueryPluginJPicker from 'svgedit/editor/jgraduate/jQuery.jPicker.js';
import jQueryPluginDBox from 'svgedit/editor/dbox.js';

import {
  readLang, putLocale,
  setStrings,
  init as localeInit
} from 'svgedit/editor/locale/locale.js';
import loadStylesheets from 'svgedit/editor/external/load-stylesheets/index-es.js';
    ...
    async callback (icons) {
      ...
      if (curConfig.stylesheets.length) {
        ...
        stylesheets = stylesheets.map(function(style){
          return 'themes/basic/svg-editor/' + style;
        })
