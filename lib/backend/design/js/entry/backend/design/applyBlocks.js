...
export default function(){
    ...
    $('.block[data-type]', frame).append(`
        <span class="menu-widget root-block-menu">
            <span class="add-box add-box-single" title="Add Widget">Add Widget</span>
            ${entryData.designer_mode ? `<span class="export root-export" title="Export Block"></span>` : ''}
        </span>`);

    $('.box-block', frame).append(`
        <span class="menu-widget">
            <span class="add-box" title="Add Widget">Add Widget</span>
            <span class="edit-box" title="Edit Block"></span>
            <span class="handle" title="Move block"></span>
            ${entryData.designer_mode ? `<span class="export" title="Export Block"></span>` : ''}
    ...
    $('.box', frame).append(`
        <span class="menu-widget">
            ...
            ${entryData.designer_mode && false ? `<span class="edit-css" title="Edit widget styles (global for all same widgets)"></span>` : ''}
            <span class="handle" title="Move block"></span>
            ${entryData.designer_mode ? `<span class="export" title="Export Block"></span>` : ''}
            <span class="remove-box" title="Remove Widget"></span>
        </span>`);
