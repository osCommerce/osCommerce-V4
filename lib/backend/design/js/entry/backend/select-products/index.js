...
$.fn.selectProducts =function(options) {
    ...
    this.each(function() {
        ...
        $('.products-container-from .search input', $block).on('keyup', search);
        $('.products-container-to .search input', $block).on('keyup', addedProducts);
                ...
                ${ data.products_id ? `
                    <div class="row-prod">
                        ...
                        <div class="button-add">
                            <span class="btn btn-primary">${ entryData.tr.TEXT_ADD }</span>
                        </div>
                    </div>
                ` : '' }
            </div>
        `);
            ...
            $('.button-add .btn', $item).on('click', () => addProduct(data));
