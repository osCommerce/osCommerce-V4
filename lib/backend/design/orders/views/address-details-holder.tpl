    ...
    <div class="process-order-box">
        ...
        <div class="process-order-item process-order-item-5">
            <div class="cr-ord-cust cr-ord-cust-bmethod">
                <span>{$smarty.const.T_BILL_METH}<a href="{Yii::$app->urlManager->createUrl(['orders/transactions', 'orders_id' => $order->order_id])}" class="popup" data-class="popupEditCat"> </a></span>
