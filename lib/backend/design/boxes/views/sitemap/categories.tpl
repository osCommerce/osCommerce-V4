                ...
                <div class="tab-pane active menu-list" id="type">
                    ...
                    <div class="setting-row">
                        ...
                        <select name="setting[0][show_products]" id="" class="form-control">
                            <option value=""{if $settings[0].show_products == ''} selected{/if}>{$smarty.const.TEXT_BTN_NO}</option>
                            <option value="1"{if $settings[0].show_products == '1'} selected{/if}>{$smarty.const.TEXT_BTN_YES}</option>
                        </select>
