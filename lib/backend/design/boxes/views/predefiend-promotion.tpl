    ...
    <div class="popup-content box-img">
        <div class="tabbable tabbable-custom">
            ...
            <div class="tab-content">
                <div class="tab-pane active menu-list" id="promo">
                    <div class="">
                        <div class="setting-row">
							<label>Display Promo:</label>
							{\yii\helpers\Html::dropDownList('setting[0][promo_id]', $settings[0].promo_id, $promo, ['class' => 'form-control', 'prompt' => 'please select'])}
                        </div>
                    </div>
