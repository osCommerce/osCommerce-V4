...
<div class="noti-btn">
    <label><input type="checkbox" name="overwrite_existing_attributes" value="1"> {$smarty.const.TEXT_OVERWRITE_EXISTING_ATTRIBUTES}</label>
</div>
<div class="noti-btn">
    <div class="btn-left">
...
<script type="text/javascript">
  ...
  $('#btnAssignCatalog').on('click',function(){
    $.ajax({
      ...
      type: 'POST',
      data: {
        'overwrite_existing_attributes': $('input[name="overwrite_existing_attributes"]').is(':checked'),
        'selected_data': JSON.stringify(selected_data)
      },
      success: function (data) {
