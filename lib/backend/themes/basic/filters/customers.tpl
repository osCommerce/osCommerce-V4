...
<div class="filter-box filter-box-cus {if $isMultiPlatform}filter-box-pl{/if}">
    ...
    <div class="row m-t-2">
        ...
        <div class="col-sm-10">
            <div class="row">
                <div class="col-sm-4 f_td_country">
                ...
                {if $app->controller->view->showState == true}
                    <div class="col-sm-4 f_td_state"><input name="state" id="selectState" type="text" value="{$app->controller->view->filters->state}" placeholder="{$smarty.const.TEXT_TYPE_COUNTY}" class="form-control" {if $app->controller->view->filters->country == ''}disabled{/if}></div>
                {/if}
                <div class="col-sm-4 f_td_city"><input name="city" id="selectCity" type="text" value="{$app->controller->view->filters->city}" placeholder="{$smarty.const.TEXT_TYPE_CITY}" class="form-control" {if $app->controller->view->filters->state == ''}disabled{/if}></div>
            </div>
        </div>
    </div>
    ...
    <div class="row m-t-2">
        ...
        <div class="col-sm-5 f_td_company">
    ...
    <div class="row m-t-2">
        ...
        <div class="col-sm-5">
            <div class="f-row row align-items-center">
                <div class="f_td_radio col-sm-5 p-r-0">
                    <label class="row align-items-center">
                            <div class="col-sm-3 p-l-0 p-r-0">
                                <input type="radio" name="date" value="presel" id="presel" class="form-control" {if $app->controller->view->filters->presel}checked{/if} />
                            </div>
    ...
    <div class="row m-t-2">
        ...
        <div class="col-sm-10">
            <div class="f-row row align-items-center">
                <div class="f_td_radio col-sm-3">
                    <label class="row align-items-center">
                        <div class="col-sm-3 p-l-0 p-r-0">
                            <input type="radio" name="date" value="exact" id="exact" class="form-control" {if $app->controller->view->filters->exact}checked{/if} />
                        </div>
                        <div class="col-sm-9 p-l-0 p-r-0">
                ...
                <div class="f_td2 col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-1 align-right p-l-0">
